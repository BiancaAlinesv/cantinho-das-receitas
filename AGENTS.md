# Cantinho das Receitas - PiperBrain MCP
...
The MCP connection config is stored in `.piperbrain.json`. Project configuration: `http://localhost:9751/p/53774869-40fe-4d46-a861-de33efe45f51-cantinho-das-receitas/config`.
...
```json
{
  ...
  "mcp": {
    "piperbrain": {
      "type": "remote",
      "url": "http://localhost:9751/mcp/sse?project=53774869-40fe-4d46-a861-de33efe45f51",
      "enabled": true
    }
  }
}
...
Project configuration is available at `http://localhost:9751/p/53774869-40fe-4d46-a861-de33efe45f51-cantinho-das-receitas/config`.
...
- **UUID**: 53774869-40fe-4d46-a861-de33efe45f51
- **Server**: http://localhost:9751
- **MCP Endpoint**: http://localhost:9751/mcp/sse?project=53774869-40fe-4d46-a861-de33efe45f51
